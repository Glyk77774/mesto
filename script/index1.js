...
const bioInput = formEdit.querySelector(".popup__input_type_job");
const profileName = document.querySelector(".profile__info-name");
const profileBio = document.querySelector(".profile__info-job");

const popupAdd = document.querySelector(".popup_add_foto");
const buttonAdd = document.querySelector(".profile__user-button");
...
const popupOpen = document.querySelector(".popup_foto_card");
const popupOpenImage = popupOpen.querySelector(".popup__image-card");
const popupOpenTitle = popupOpen.querySelector(".popup__title-card");

const buttonClose = document.querySelectorAll(".popup__close");

const feedList = document.querySelector(".elements__list");
const cardTemplate = document.querySelector("#elements-add").content;
